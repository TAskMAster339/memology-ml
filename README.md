...
| ------------------------- | ------------------------------------------------------------ |
| "кот пьет кофе"           | ![Cat drinking coffee](examples/cat_with_coffee_example.png) |
| "лошадь чихнула"          | ![Horse sneezed](examples/horse_example.png)                 |
| "компьютер и ежу понятен" | ![Computer obvious](examples/computer_example.png)           |
