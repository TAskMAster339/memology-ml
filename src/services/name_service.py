...
class NameService:
    ...
    SYSTEM_PROMPT = """
    Ты — генератор коротких названий для мема.
    ...
    Отвечай в формате json, с полями name и tags. Верни ровно один json.
    Например,
    {
        "name": "Кофе для кота",
        "tags": ["кофе", "кот", "пьет", "латте", "кофе-кот"]
    }
    """  # noqa: RUF001
    ...
    def generate_name(self, scene_description: str) -> str:
        """
        Generates a short meme name.
        ...
        """
        self.logger.info("Generating name")
